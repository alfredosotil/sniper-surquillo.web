...
<div class="order-detail-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\common\models\base\Order::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Order', 'id' => 'grid-order-detail-search-order_id']
            ],
        'description',
        'price_per_unit',
        'price',
