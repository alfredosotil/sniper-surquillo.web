...
/**
 * This is the base model class for table "user_assistance".
 *
 * @property integer $id
...
class UserAssistance extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\UserAssistanceQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\UserAssistanceQuery(get_called_class());
        return $query->where(['user_assistance.deleted_by' => 0]);
    }
}
