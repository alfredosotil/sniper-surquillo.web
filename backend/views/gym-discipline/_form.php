...
\mootensai\components\JsBlock::widget(['viewFile' => '_script', 'pos'=> \yii\web\View::POS_END, 
    'viewParams' => [
        ...
        'relID' => 'user-assistance', 
        'value' => \yii\helpers\Json::encode($model->userAssistances),
...
<div class="gym-discipline-form">
    ...
    $forms = [
        [
            'label' => '<i class="glyphicon glyphicon-book"></i> ' . Html::encode(Yii::t('app', 'UserAssistance')),
            'content' => $this->render('_formUserAssistance', [
                'row' => \yii\helpers\ArrayHelper::toArray($model->userAssistances),
            ]),
        ],
    ];
