...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'class_id' => ['type' => TabularForm::INPUT_TEXT],
        'class_type' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowOrderDetail(' . $key . '); return false;', 'id' => 'order-detail-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
